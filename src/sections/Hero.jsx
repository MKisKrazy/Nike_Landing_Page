...
const [bigShoeImg,setBigShoeImg]=useState(bigShoe1)
  ...
  return (
    <section id="home" className="w-full flex flex-col xl:flex-row min-h-screen justify-center gap-10 max-container">
        ...
        {shoes.map((shoe)=>{
          return(
            <div key={shoe}>
              <ShoeCard 
                imgUrl={shoe}
                changeBigShoeImage={(selectedShoe)=>{setBigShoeImg(selectedShoe)}}
